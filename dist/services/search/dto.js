...
exports.toSearchCandidate = void 0;
...
function mapCategoryToPropertyType(category) {
    ...
    if (normalized.includes('VILLA'))
        return 'VILLA';
    if (normalized.includes('INDEPENDENT') || normalized.includes('HOUSE') || normalized.includes('DUPLEX'))
...
function toSearchCandidate(property) {
    return {
        id: property.id,
...
exports.toSearchCandidate = toSearchCandidate;
