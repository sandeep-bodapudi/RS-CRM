...
import { WebsiteActivityTrackInput } from '../../shared';

const p = prisma;

export class WebsiteActivityService {
  ...
  static async track(companyId: number, accountId: number | null, data: WebsiteActivityTrackInput) {
    try {
