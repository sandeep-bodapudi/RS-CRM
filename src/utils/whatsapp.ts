...
const WHATSAPP_TEMPLATES: Record<WhatsAppTemplateId, string> = {
  PM_CONTACT_RELAY:
    'Hi {{customer_name}}, this is regarding your upcoming site visit for {{project_name}}. Your Project Manager is {{pm_name}} ({{pm_phone}}). Please coordinate with them for any immediate questions.',
  RESCHEDULE_REQUEST:
    'Hi {{customer_name}}, we noticed you requested a reschedule for your site visit at {{project_name}}. Could you let us know your preferred new date and time?',
  CREDENTIAL_DELIVERY:
    'Hi {{customer_name}}, welcome to RRH! You can track your site visits and properties on our customer portal. Your login is: {{phone}} and your temporary password is: {{password}}.',
  PROPERTY_SHARE:
    'Hi {{customer_name}}, here are the details for the property we discussed: {{property_link}}',
  SITE_VISIT_FEEDBACK:
    'Hi {{customer_name}}, thank you for visiting with {{pm_name}}! We would love a minute of your feedback: {{feedback_link}}',
};
